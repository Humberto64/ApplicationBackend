...
public class DependentServiceImpl implements DependentService {
    ...
    @Override
    public DependentResponse updateDependent(Long id, DependentRequest request) {

        Dependent existing = dependentRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Dependiente no encontrado con ID: " + id));
        ...
        boolean duplicated = dependentRepository.existsByNameAndEmployee_Id(request.getName(), employee.getId())
        ...
        dependentRepository.save(existing);
